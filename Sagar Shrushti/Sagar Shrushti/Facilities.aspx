...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="FacilitiesPanel">
        ...
        <div id="FacilitiesBody" style="font-family: Trebuchet MS; color: #B2DBFF; font-size: 18px;
            text-align: left;">
    ...
    <div id="LimitationsPanel">
        <div id="LimitationsHeader" style="padding-bottom: 8px; font-family: Trebuchet MS;
            color: #B2DBFF; font-size: 24px; font-style: italic; font-weight: bolder;">
            Our Limitations</div>
        <div id="LimitationsBody" style="font-family: Trebuchet MS; color: #B2DBFF; font-size: 18px;
            text-align: left;">
